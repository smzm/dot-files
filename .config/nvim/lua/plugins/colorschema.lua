...
return {
	...
	config = function()
		...
		-- Hilights for the cursor and visual selection
		vim.cmd([[highlight Indentation ctermfg=NONE ctermbg=15 gui=NONE guifg=#292B3E guibg=NONE]])
		vim.cmd([[highlight IndentBlanklineContextChar ctermfg=NONE ctermbg=15 gui=NONE guifg=#292B3E guibg=NONE]])
		vim.cmd([[highlight HighlightedBG ctermfg=NONE gui=NONE guibg=#1E2030]])
	end,
}
