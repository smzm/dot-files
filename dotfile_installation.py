...
if yazi_check:
    ...
    if yazi_config_answer["interest"] == "Yes":
        ...
        if yazi1 and yazi2:
            ...
            subprocess.run("cd ~/.config/yazi/ ; ya pack -a yazi-rs/plugins:full-border imsi32/yatline MasouShizuka/projects DreamMaoMao/fg AnirudhG07/plugins-yazi:copy-file-contents Lil-Dank/lazygit", shell=True)
else:
